    ...
    <div className="min-h-screen bg-sf-navy-dark flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-sf-navy font-heading tracking-wide">SiteForge</h1>
          <div className="h-0.5 w-16 bg-sf-orange mx-auto mt-3 mb-3" />
          <p className="text-sm text-gray-500 font-medium uppercase tracking-wide">Construction Management Platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="button" onClick={loginAsDemo}
            className="w-full border-2 border-sf-navy text-sf-navy font-bold py-3.5 px-6 rounded-lg hover:bg-sf-navy hover:text-white transition-colors font-heading tracking-wide text-lg">
            Try Demo
          </button>
        </form>
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-500">
            ...
            <a href="/signup" className="text-sf-orange font-semibold hover:underline">Sign up</a>
          </p>
        </div>
